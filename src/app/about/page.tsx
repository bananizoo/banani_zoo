    ...
    <div className={styles.page}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        ...
        <div className={styles.feature}>
          ...
          <p>
            Передбачено авторизацію користувача та адмін-інтерфейс для
            керування товарами й замовленнями.
          </p>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between gap-2 w-full">
          <div className="flex flex-col justify-center w-[50%] max-w-lg">
            ...
            <p className={`${styles.ctaText} mt-3`}>
              Перейдіть у калькулятор або на головну — навбар зверху завжди
              поруч.
            </p>
